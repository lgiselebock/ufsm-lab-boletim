---
title: "O Consumo e o Endividamento Brasileiro entre os anos de 2019 e 2022"
...
## Consumo Final das Famílias Brasileiras – em milhões de R$ – 2019/2022 {.smaller}
...
knitr::include_graphics(
  here::here("docs", "graficos_files", "figure-html", "figura-01-1.png")
)
...
## Taxa de variação acumulada em 12 meses do consumo per capita das famílias – % – 2019/2022 {.smaller}
...
knitr::include_graphics(
  here::here("docs", "graficos_files", "figure-html", "figura-02-1.png")
)
...
Apresenta o quanto o consumo por pessoa das famílias brasileiras variou em comparação com os últimos 12 meses. 
...
knitr::include_graphics(
  here::here("docs", "graficos_files", "figure-html", "figura-03-1.png")
)
...
- Intensificação do número de **famílias com contas em atraso** -- de 22.9% para 30,3% -- indicando um acréscimo de 7,4 pontos percentuais.
...
knitr::include_graphics(
  here::here("docs", "graficos_files", "figure-html", "figura-04-1.png")
)
