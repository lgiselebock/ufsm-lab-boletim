...
consumo <- readxl::read_xls(
    here::here("docs", "data", "2019-2022-ipeadata-pib-consumo-final-das-familias.xls")
  ) |> 
  janitor::clean_names() |> 
...
variacao_12_meses <- readxl::read_excel(
  here::here("docs", "data", "2019-2022-variacao-consumo-acumulado-12-meses.xls")
) |> 
  janitor::clean_names() |> 
  ...
  tidyr::drop_na() |> 
    ...
    # variacao_perc = as.double(glue::glue("{variacao}", "%"))
  )
...
endividamento <- readxl::read_excel(
  here::here("docs", "data", "2019-2022-cnc-endividamento-familiar.xls")
) |> 
  janitor::clean_names() |> 
...
icf <- readxl::read_excel(
    here::here("docs", "data", "2019-2022-icf-serie-historica.xls")
  ) |> 
  janitor::clean_names() |> 
  dplyr::select("x1", "icf") |> 
  dplyr::rename("data" = "x1") |> 
...
icf |> 
  ...
  annotate(
    "text",
    x = c(as.Date("2019-02-27"), as.Date("2020-03-10"), as.Date("2020-06-20"), as.Date("2022-10-01")),
    y = c(105, 105, 75, 92),
